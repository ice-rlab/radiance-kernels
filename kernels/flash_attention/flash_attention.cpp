...
// matmul_data.h doesn't exist and isn't generated by any script in this repo;
// nothing else here references a symbol from it (numpy_a_bin/numpy_b_bin are
// declared separately below). gemm_mxgemmini/mxgemm.cpp comments out its own
// equivalent data-header include the same way, so this looks like dead code.
